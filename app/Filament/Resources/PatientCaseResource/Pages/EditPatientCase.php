...
class EditPatientCase extends EditRecord
{
    ...
    {
        return [
            Actions\ViewAction::make()->label('বিস্তারিত দেখুন'),
            ...
            Actions\Action::make('extendDuration')
                ...
                ->action(function (PatientCase $record, array $data): void {
                    ...
                    $this->refreshFormData(['status', 'published_at', 'expires_at']);
                }),

            // Publish Action in header
            Actions\Action::make('publish')
                ...
                ->action(function (PatientCase $record, VerificationService $service): void {
                    try {
                        ...
                        $this->refreshFormData(['status', 'published_at', 'expires_at', 'verified_at', 'verified_by']);
            ...
            Actions\DeleteAction::make()->label('মুছে ফেলুন'),
        ];
    }
